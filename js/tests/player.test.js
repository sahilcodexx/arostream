...
vi.mock('../storage.js', () => ({
    ...
    binauralDspSettings: {
        ...
        setEnabled: vi.fn(),
        getCrossfeedEnabled: vi.fn(() => false),
        setCrossfeedEnabled: vi.fn(),
        getCrossfeedLevel: vi.fn(() => 0),
        setCrossfeedLevel: vi.fn(),
        getHrtfPreset: vi.fn(() => 'default'),
        setHrtfPreset: vi.fn(),
        getWideningEnabled: vi.fn(() => false),
        setWideningEnabled: vi.fn(),
        getWideningAmount: vi.fn(() => 0),
        setWideningAmount: vi.fn(),
        getAutoEnableForSpatial: vi.fn(() => false),
        setAutoEnableForSpatial: vi.fn(),
    },
